...
```
java -Dspring.profiles.active=production -jar ./target/hotel-bookiing-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/hotel-bookiing
```
